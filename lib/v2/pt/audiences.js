...
module.exports = async (ctx) => {
    ...
    const items = $('#torrenttable > tbody > tr')
        ...
        .map((item) => {
            ...
            return {
                ...
                enclosure_url: `https://audiences.me/download.php?id=${id}&passkey=${passkey}`,
    ...
    ctx.state.data = {
        title: `Audiences Torrents 共` + items.length + `个种子`,
        link: `https://audiences.me`,
        description: `Latest torrents from Audiences`,
        item: items,
    };
};
